...
// Brand paths from Simple Icons (https://simpleicons.org/) and Lobe Icons (https://lobehub.com/icons)

export function GeminiLogo({ className, ...props }: IconProps) {
...
export function ClaudeLogo({ className, ...props }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function KimiLogo({ className, ...props }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function ZAiLogo({ className, ...props }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function DeepSeekLogo({ className, ...props }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function MistralLogo({ className, ...props }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function XAiLogo({ className, ...props }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function MetaAiLogo({ className, ...props }: IconProps) {
  const gradientId = React.useId();
...
export function GroqLogo({ className, ...props }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
