...
Optional channel adapter registered in `new Hitl({ adapters })` on top of the built-in [web inbox](/docs/channels/web-inbox). You can use both: inbox for internal tools, Chat SDK for Slack/Teams.
