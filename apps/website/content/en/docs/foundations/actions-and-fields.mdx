...
Pass `approvalActions` to [`waitForHuman`](/docs/foundations/human-steps) or [`requestHuman`](/docs/foundations/human-steps). The builder preserves literal action ids for TypeScript inference on results.
...
- [Human steps](/docs/foundations/human-steps): pass actions to the workflow client
